...
pub use super::lossless_tee::{
    LosslessTeeCommit, LosslessTeeReservation, commit_lossless_if_better_for_cmd,
    commit_lossless_if_better_for_powershell, reserve_lossless_tee,
};
use crate::core::config::Config;

#[cfg(test)]
pub(crate) use super::lossless_tee::reserve_lossless_tee_file;
pub(crate) use super::lossless_tee::{
    LosslessTeeReservationError, get_tee_dir, reserve_lossless_tee_for_emission,
    resolve_lossless_recovery,
};
