...
| [`codex/`](../hooks/codex/README.md) | OpenAI Codex CLI | Native PreToolUse adapter, AGENTS.md, and MCP |
...
| Codex CLI | Native hook + instructions | `PreToolUse` in config.toml | Yes in bypass mode |
